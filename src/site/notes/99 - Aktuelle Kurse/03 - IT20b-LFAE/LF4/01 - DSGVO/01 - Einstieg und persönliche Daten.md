...
- Wir können aufgrund von social media posts verfolgt bzw. aufgefunden werden (auch, wenn wir das gar nicht möchten).
- Standort wird meist pauschal erfasst --> Einstellung auf "nie" ändern; nur dann anschalten, wenn wirklich bewusst genutzt werden soll (und danach gleich wieder aus).
- Einstellungen werden oft nur bei erster Installation abgefragt --> Wir wissen z. T. nicht, welche Daten wir teilen.
...
**FISI**
- Telefonisch gemeldete Netzwerkstörung (Telefonnummer als pers.bez. Daten)
- Mit einem Kunden Details zu Netzwerkeinrichtung besprechen (Kundendaten)
- Auswechseln von Datenträgern (Datenträger sicher löschen / zerstören)
- Einrichtung von Netzwerken (Zugriffsabsicherung - z. B. (software)technische Maßnahmen)

**Kaufleute**
- Lieferprozesse (Kundendaten)
- Analyse der Geschäftsprozesse (Interne Daten des Kunden)
- Kosten- und Nutzenanalyse (Werte des Kunden werden analysiert und abgewogen)
- Vertragserstellung (Kundendaten)
- Datenerhebung von Rechnungsdaten (Kundendaten)
- Steuerung und Kontrolle (ggf. Stundenzettel der Mitarbeiter / Lohnabrechnungen)
