...
- Digital Garden
	- Ein echt tolles Plugin (das allerdings wirklich einigen Sachverstand erfordert, um korrekt konfiguriert zu werden - es sind dazu auch einige Accounts bei Webdiensten wie z. B. GitHub, Vercel oder Netlify nötig), das einen "digitalen Garten" anlegt. Das ist im Grunde eine Website, auf der ich mit einem einzigen Befehl hübsch formatiert meine Notizen veröffentlichen kann - z. B. diesen Beitrag. Es ist also ein Blog, nur ohne die Möglichkeit der Interaktion.
- Excalidraw
